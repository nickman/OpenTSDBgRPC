 ...
 * <p><code>net.opentsdb.grpc.server.streaming.client.ClientStreamer</code></p>
 */
...
public class ClientStreamer<T, R> extends AbstractStreamer<T, R> {
	...
	/**
	 * {@inheritDoc}
	 * @see net.opentsdb.grpc.server.streaming.client.Streamer#send(java.lang.Object)
	 */
	...
	/**
	 * {@inheritDoc}
	 * @see net.opentsdb.grpc.server.streaming.client.AbstractStreamer#responseObserver()
	 */
	@Override
