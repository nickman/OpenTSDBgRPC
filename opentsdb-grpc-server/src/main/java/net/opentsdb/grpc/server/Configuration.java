...
import net.opentsdb.grpc.server.util.TUnit;
...
public class Configuration {
	...
	public static final int DEFAULT_GRPC_MAX_HEADERLIST_SIZE = GrpcUtil.DEFAULT_MAX_HEADER_LIST_SIZE * 2;

	public static final String GRPC_MAX_MESSAGE_SIZE = "grpc.server.maxmessagesize";
	public static final int DEFAULT_GRPC_MAX_MESSAGE_SIZE = GrpcUtil.DEFAULT_MAX_MESSAGE_SIZE;
