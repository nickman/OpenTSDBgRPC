...
public class BootRpcPlugin extends RpcPlugin {
	RpcPlugin delegate = null;
	/**
	 * {@inheritDoc}
	...
	public void initialize(TSDB tsdb) {
		...
		try {
			Class<? extends RpcPlugin> clazz = (Class<? extends RpcPlugin>) Class.forName("net.opentsdb.grpc.server.GRPCPlugin", true, icl);
