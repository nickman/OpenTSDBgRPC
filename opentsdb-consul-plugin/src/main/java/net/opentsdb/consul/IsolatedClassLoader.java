 ...
 * <p><code>net.opentsdb.grpc.server.IsolatedClassLoader</code></p>
 */
...
public class IsolatedClassLoader extends ClassLoader {
	 ...
	 */
	public static IsolatedClassLoader embeddedJarClassLoader(final URL url, final String manifestKey) {
		InputStream is = null;
